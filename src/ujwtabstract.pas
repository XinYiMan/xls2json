...
uses
  Classes, SysUtils, Crypto_JWT, DateUtils, uGenericDateFunctions, uExtended_fphttpapp;
...
begin
     ...
     result     := JWTSign(jwt_password,'{ "iduser" : "' + id_user + '" , "value1" : "' + value1 + '" , "value2" : "' + value2 + '", "value3" : "' + value3 + '", "value4" : "' + value4 + '" , "web_app_version" : "' + web_app_version + '", "expired" : "' + expired_dt + '" }');
end;
        ...
        begin
             ...
             begin
                  ...
                  begin
                       ...
                       ret := JWTSign(jwt_password,'{ "iduser" : "' + id_user + '" , "value1" : "' + value1 + '" , "value2" : "' + value2 + '", "value3" : "' + value3 + '", "value4" : "' + value4 + '" , "web_app_version" : "' + web_app_version + '", "expired" : "' + expired_dt + '" }');
                  end;
